    ...
    return (
        ...
        >
            ...
            >
                ...
                {/* Discount badge */}
                {product.discount && (
                    <div className="absolute top-2 left-2 flex items-center gap-1 px-2 py-0.5 rounded-full bg-red-500 shadow-lg">
            ...
            <div className="relative p-3 md:p-4 flex flex-col flex-1">
                ...
                <div className="flex items-center gap-1.5 mt-auto">
                    ...
                    <Link
                        to={`/products/${product.id}`}
                        className="w-8 h-8 rounded-full bg-white/[0.03] border border-white/[0.08] flex items-center justify-center text-white hover:border-[var(--color-brand-400)]/50 hover:bg-white/[0.05] transition-all flex-shrink-0"
                    >
                        <ArrowUpRight
                            size={12}
