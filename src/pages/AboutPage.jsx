            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                ...
                >
                    ...
                    <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6 leading-tight">
                        Full-service digital marketing from{" "}
                        <span className="text-[var(--color-brand-400)]">Kota & Indore</span>
                    </h2>

                    <div className="space-y-4 text-[var(--color-text-secondary)] leading-relaxed">
                        <p>
                            <span className="text-white font-semibold">Digitee World</span> is
                            a full-service Digital Marketing Company in Kota and Indore,
                            dedicated to helping startups, local businesses, and established
                            brands build a powerful online presence and achieve measurable
                            growth.
                        </p>
                        <p>
                            ...
                            — just as every physical system moves forward through the right
                            balance of force, energy, and momentum, every business grows
                            through the right mix of strategy, consistency, and data-driven
                            action.
                        </p>
                        <p>
                            As a leading Digital Marketing Agency in Kota and Indore, we offer
                            a complete range of services designed to generate leads, boost
                ...
                >
                    ...
                    <div className="relative p-8 md:p-10 rounded-3xl bg-gradient-to-br from-white/[0.04] to-white/[0.01] border border-white/[0.08] backdrop-blur-xl overflow-hidden">
                        <div className="absolute top-0 right-0 w-40 h-40 bg-[var(--color-brand-400)]/15 rounded-full blur-2xl" />

                        <div className="relative">
                            <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-[var(--color-brand-500)] to-[var(--color-brand-400)] flex items-center justify-center mb-6 shadow-[0_0_30px_rgba(34,211,238,0.4)]">
                            ...
                            <p className="text-[var(--color-text-secondary)] leading-relaxed mb-6">
                                To deliver smart, ethical, and result-oriented digital marketing
                                solutions that empower businesses to build trust, grow
                                consistently, and achieve real, measurable success.
                            </p>
