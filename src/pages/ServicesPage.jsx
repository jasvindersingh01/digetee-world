      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-10 m-10">
        ...
        >
          {categories.map((cat) => {
            ...
            // Only show categories with services
...
const HeroSection = () => (
  <div className="relative w-full overflow-hidden pt-32 pb-16 md:pt-40 md:pb-20">
    ...
    <div className="relative z-10 max-w-5xl mx-auto px-6 lg:px-10 text-center">
      ...
      >
        From local SEO and WhatsApp marketing to AI-powered automation — we
        deliver end-to-end digital services designed to help your business grow
        consistently.
      </motion.p>
    </div>
  </div>
...
const ServiceRow = ({ service, index }) => {
  ...
  return (
    ...
    >
      ...
      <div
        className={`relative grid lg:grid-cols-2 gap-8 lg:gap-12 items-center p-6 md:p-10 lg:p-12 ${
